...
public class VerbGrammaConjugater {
	...
	public static List<GrammaFormConjugateGroupTypeElements> makeAll(KeigoHelper keigoHelper,
		...
		formal.getGrammaFormConjugateResults().add(
				makeFormalPresentForm(keigoHelper, dictionaryEntry, isKeigoHigh, isKeigoLow));
		formal.getGrammaFormConjugateResults().add(
				makeFormalPresentNegativeForm(keigoHelper, dictionaryEntry, isKeigoHigh, isKeigoLow));
		formal.getGrammaFormConjugateResults().add(
				makeFormalPastForm(keigoHelper, dictionaryEntry, isKeigoHigh, isKeigoLow));
		formal.getGrammaFormConjugateResults().add(
				makeFormalPastNegativeForm(keigoHelper, dictionaryEntry, isKeigoHigh, isKeigoLow));
		...
		mashouForm.getGrammaFormConjugateResults().add(
				makeMashouForm(keigoHelper, dictionaryEntry, isKeigoHigh, isKeigoLow));
		...
		if (isAruVerb == false && isGozaruVerb == false) {
			...
			potentialInformalForm.getGrammaFormConjugateResults().add(
					makePotentialFormInformalPresentNegativeForm(potentialFormInformalPresentForm));
			potentialInformalForm.getGrammaFormConjugateResults().add(
					makePotentialFormInformalPastForm(potentialFormInformalPresentForm));
			potentialInformalForm.getGrammaFormConjugateResults().add(
					makePotentialFormInformalPastNegativeForm(potentialFormInformalPresentForm));
			...
			// formalna
			potentialFormalForm.getGrammaFormConjugateResults().add(
					makePotentialFormFormalPresentForm(keigoHelper, potentialFormInformalPresentForm));
			potentialFormalForm.getGrammaFormConjugateResults().add(
					makePotentialFormFormalPresentNegativeForm(keigoHelper, potentialFormInformalPresentForm));
			potentialFormalForm.getGrammaFormConjugateResults().add(
					makePotentialFormFormalPastForm(keigoHelper, potentialFormInformalPresentForm));
			potentialFormalForm.getGrammaFormConjugateResults().add(
					makePotentialFormFormalPastNegativeForm(keigoHelper, potentialFormInformalPresentForm));
		...
		// forma bierna
		{
			...
			passiveInformalForm.getGrammaFormConjugateResults().add(
					makePassiveFormInformalPresentNegativeForm(passiveFormInformalPresentForm));
			passiveInformalForm.getGrammaFormConjugateResults().add(
					makePassiveFormInformalPastForm(passiveFormInformalPresentForm));
			passiveInformalForm.getGrammaFormConjugateResults().add(
					makePassiveFormInformalPastNegativeForm(passiveFormInformalPresentForm));
			...
			// formalna
			passiveFormalForm.getGrammaFormConjugateResults().add(
					makePassiveFormFormalPresentForm(keigoHelper, passiveFormInformalPresentForm));
			passiveFormalForm.getGrammaFormConjugateResults().add(
					makePassiveFormFormalPresentNegativeForm(keigoHelper, passiveFormInformalPresentForm));
			passiveFormalForm.getGrammaFormConjugateResults().add(
					makePassiveFormFormalPastForm(keigoHelper, passiveFormInformalPresentForm));
			passiveFormalForm.getGrammaFormConjugateResults().add(
					makePassiveFormFormalPastNegativeForm(keigoHelper, passiveFormInformalPresentForm));
		...
		// forma sprawcza
		{
			...
			causativeInformalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormInformalPresentNegativeForm(causativeFormInformalPresentForm));
			causativeInformalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormInformalPastForm(causativeFormInformalPresentForm));
			causativeInformalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormInformalPastNegativeForm(causativeFormInformalPresentForm));
			...
			// formalna
			causativeFormalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormFormalPresentForm(keigoHelper, causativeFormInformalPresentForm));
			causativeFormalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormFormalPresentNegativeForm(keigoHelper, causativeFormInformalPresentForm));
			causativeFormalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormFormalPastForm(keigoHelper, causativeFormInformalPresentForm));
			causativeFormalForm.getGrammaFormConjugateResults().add(
					makeCausativeFormFormalPastNegativeForm(keigoHelper, causativeFormInformalPresentForm));
		...
		// forma sprawczo-bierna
		{
			...
			causativePassiveInformalForm
					.setGrammaFormConjugateGroupType(GrammaFormConjugateGroupType.VERB_CAUSATIVE_PASSIVE_INFORMAL);
			...
			causativePassiveInformalForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveFormInformalPresentNegativeForm(causativePassiveFormInformalPresentForm));
			causativePassiveInformalForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveFormInformalPastForm(causativePassiveFormInformalPresentForm));
			causativePassiveInformalForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveFormInformalPastNegativeForm(causativePassiveFormInformalPresentForm));
			...
			causativePassiveFormalForm
					.setGrammaFormConjugateGroupType(GrammaFormConjugateGroupType.VERB_CAUSATIVE_PASSIVE_FORMAL);

			// formalna
			causativePassiveFormalForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveFormFormalPresentForm(keigoHelper, causativePassiveFormInformalPresentForm));
			causativePassiveFormalForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveFormFormalPresentNegativeForm(keigoHelper,
							causativePassiveFormInformalPresentForm));
			causativePassiveFormalForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveFormFormalPastForm(keigoHelper, causativePassiveFormInformalPresentForm));
			causativePassiveFormalForm.getGrammaFormConjugateResults()
					.add(makeCausativePassiveFormFormalPastNegativeForm(keigoHelper,
							causativePassiveFormInformalPresentForm));
			...
			causativePassiveTeForm
					.setGrammaFormConjugateGroupType(GrammaFormConjugateGroupType.VERB_CAUSATIVE_PASSIVE_TE);

			causativePassiveTeForm.getGrammaFormConjugateResults().add(
					makeCausativePassiveTeForm(causativePassiveFormInformalPresentForm));
	...
	private static GrammaFormConjugateResult makeFormalPresentForm(KeigoHelper keigoHelper,
			DictionaryEntry dictionaryEntry, boolean isKeigoHigh, boolean isKeigoLow) {
		...
		if (isKeigoHigh == false && isKeigoLow == false) {
			return makeVerbGrammaConjugateFormalForm(dictionaryEntry,
					GrammaFormConjugateResultType.VERB_FORMAL_PRESENT, postfixKana, postfixRomaji);
		} else {

			KeigoEntry keigoEntry = null;

			if (isKeigoHigh == true) {
				keigoEntry = keigoHelper.getKeigoHighEntryFromKeigoWord(dictionaryEntry.getKanji(), null,
						dictionaryEntry.getKanaList().get(0), null);

			} else if (isKeigoLow == true) {
				keigoEntry = keigoHelper.getKeigoLowEntryFromKeigoWord(dictionaryEntry.getKanji(), null,
						dictionaryEntry.getKanaList().get(0), null);
			}
			...
			if (keigoEntry.getKeigoLongFormWithoutMasuKana() != null) {
				return makeKeigoHighFormalForm(dictionaryEntry, keigoEntry,
						GrammaFormConjugateResultType.VERB_FORMAL_PRESENT, postfixKana, postfixRomaji);
			} else {
				return makeVerbGrammaConjugateFormalForm(dictionaryEntry,
						GrammaFormConjugateResultType.VERB_FORMAL_PRESENT, postfixKana, postfixRomaji);
	...
	private static GrammaFormConjugateResult makeKeigoHighFormalForm(DictionaryEntry dictionaryEntry,
			KeigoEntry keigoEntry, GrammaFormConjugateResultType grammaFormConjugateResultType, String postfixKana,
			String postfixRomaji) {
	...
	private static GrammaFormConjugateResult makeFormalPresentNegativeForm(KeigoHelper keigoHelper,
			DictionaryEntry dictionaryEntry, boolean isKeigoHigh, boolean isKeigoLow) {
		...
		if (isKeigoHigh == false && isKeigoLow == false) {
			return makeVerbGrammaConjugateFormalForm(dictionaryEntry,
					GrammaFormConjugateResultType.VERB_FORMAL_PRESENT_NEGATIVE, postfixKana, postfixRomaji);
		} else {
	...
	private static GrammaFormConjugateResult makeFormalPastForm(KeigoHelper keigoHelper,
			DictionaryEntry dictionaryEntry, boolean isKeigoHigh, boolean isKeigoLow) {
		...
		if (isKeigoHigh == false && isKeigoLow == false) {
			...
			if (keigoEntry.getKeigoLongFormWithoutMasuKana() != null) {
				return makeKeigoHighFormalForm(dictionaryEntry, keigoEntry,
						GrammaFormConjugateResultType.VERB_FORMAL_PAST, postfixKana, postfixRomaji);
			} else {
				return makeVerbGrammaConjugateFormalForm(dictionaryEntry,
						GrammaFormConjugateResultType.VERB_FORMAL_PAST, postfixKana, postfixRomaji);
			}
	...
	private static GrammaFormConjugateResult makeFormalPastNegativeForm(KeigoHelper keigoHelper,
			DictionaryEntry dictionaryEntry, boolean isKeigoHigh, boolean isKeigoLow) {
		...
		if (isKeigoHigh == false && isKeigoLow == false) {
			return makeVerbGrammaConjugateFormalForm(dictionaryEntry,
					GrammaFormConjugateResultType.VERB_FORMAL_PAST_NEGATIVE, postfixKana, postfixRomaji);
		} else {
	...
	private static GrammaFormConjugateResult makeVerbGrammaConjugateFormalForm(DictionaryEntry dictionaryEntry,
		...
		DictionaryEntryType dictionaryEntryType = dictionaryEntry.getPrimaryDictionaryEntryType();
	...
	private static void validateDictionaryEntry(DictionaryEntry dictionaryEntry) {
		...
		boolean isWordVerbUResult = dictionaryEntry.isDictionaryEntryType(DictionaryEntryType.WORD_VERB_U);
		boolean isWordVerbRUResult = dictionaryEntry.isDictionaryEntryType(DictionaryEntryType.WORD_VERB_RU);
		boolean isWordVerbIrregularResult = dictionaryEntry
				.isDictionaryEntryType(DictionaryEntryType.WORD_VERB_IRREGULAR);

		if (isWordVerbUResult == false || isWordVerbRUResult == false || isWordVerbIrregularResult == false) {
		...
		if (kanji != null) {
			if (isWordVerbRUResult == true && kanji.endsWith("る") == false) {
				throw new RuntimeException(
						"dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU && kanji.endsWith(る) == false): "
								+ kanji);

			} else if (isWordVerbUResult == true && getLastCharConvertedToI(kanji) == null) {
				throw new RuntimeException(
						"dictionaryEntryType == DictionaryEntryType.WORD_VERB_U && getLastCharConvertedToI(kanji) == null"
								+ kanji);
				...
				if (kanji.endsWith("来る") == false && kanji.endsWith("くる") == false && kanji.endsWith("する") == false) {
					throw new RuntimeException(
							"kanji.endsWith(来る) == false && kanji.endsWith(くる) == false && kanji.endsWith(する) == false: "
									+ kanji);
				}
			}
		}
		...
		for (String currentKana : kanaList) {
			if (isWordVerbRUResult == true && currentKana.endsWith("る") == false) {
				throw new RuntimeException(
						"dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU && kanji.endsWith(る) == false): "
								+ currentKana);

			} else if (isWordVerbUResult == true && getLastCharConvertedToI(currentKana) == null) {
				throw new RuntimeException(
						"dictionaryEntryType == DictionaryEntryType.WORD_VERB_U && getLastCharConvertedToI(kanji) == null: "
								+ currentKana);
				...
				if (currentKana.endsWith("する") == false && currentKana.endsWith("くる") == false) {
					throw new RuntimeException(
							"currentKana.endsWith(する) == false && currentKana.endsWith(くる) == false: " + currentKana);
				}
			}
		}
		...
		for (String currentRomaji : romajiList) {
			if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU && currentRomaji.endsWith("ru") == false) {
				...
				if (currentRomaji.endsWith("suru") == false && currentRomaji.endsWith("kuru") == false) {
					throw new RuntimeException(
							"currentRomaji.endsWith(suru) == false && currentRomaji.endsWith(kuru) == false: "
									+ currentRomaji);
				}
			}
		}
	...
	private static String makeTeFormForKanjiOrKana(String text, DictionaryEntryType dictionaryEntryType) {
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU) {
			...
			if (text.equals("行く") == true || text.endsWith("行く") == true || text.equals("いく") == true
					|| text.endsWith("いく") == true) {
	...
	private static String makeTeFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType) {
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU) {
			...
			if (ikuException == false) {
				...
				if (romajiLastThreeChars != null
						&& lastRomajiCharsMapperToTeFormChar.containsKey(romajiLastThreeChars) == true) {
					return removeChars(romaji, 3) + lastRomajiCharsMapperToTeFormChar.get(romajiLastThreeChars);
				}

				String romajiLastTwoChars = getLastChars(romaji, 2);

				if (romajiLastTwoChars != null
						&& lastRomajiCharsMapperToTeFormChar.containsKey(romajiLastTwoChars) == true) {
					return removeChars(romaji, 2) + lastRomajiCharsMapperToTeFormChar.get(romajiLastTwoChars);
				}

				String romajiLastOneChar = getLastChars(romaji, 1);

				if (romajiLastOneChar != null
						&& lastRomajiCharsMapperToTeFormChar.containsKey(romajiLastOneChar) == true) {
	...
	private static String makeInformalPresentNegativeFormForKanjiOrKana(String text,
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU) {
			...
			if (text.equals("有る") == true || text.endsWith("有る") == true || text.equals("ある") == true
					|| text.endsWith("ある") == true) {
	...
	private static String makeInformalPresentNegativeFormForRomaji(String romaji,
			DictionaryEntryType dictionaryEntryType) {
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU) {
			...
			if (aruException == false) {
				...
				if (romajiLastThreeChars != null
						&& lastRomajiCharsMapperToAChar.containsKey(romajiLastThreeChars) == true) {
	...
	private static GrammaFormConjugateResult makeMashouForm(KeigoHelper keigoHelper, DictionaryEntry dictionaryEntry,
		...
		if (isKeigoHigh == false && isKeigoLow == false) {
			...
			if (keigoEntry.getKeigoLongFormWithoutMasuKana() != null) {
				return makeKeigoHighFormalForm(dictionaryEntry, keigoEntry, GrammaFormConjugateResultType.VERB_MASHOU,
						postfixKana, postfixRomaji);
			} else {
				return makeVerbGrammaConjugateFormalForm(dictionaryEntry, GrammaFormConjugateResultType.VERB_MASHOU,
						postfixKana, postfixRomaji);
	...
	private static GrammaFormConjugateResult makePotentialFormInformalPresentForm(DictionaryEntry dictionaryEntry) {
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU
				|| (dictionaryEntryType == DictionaryEntryType.WORD_VERB_IRREGULAR && kanji != null && kanji
						.endsWith("来る") == true)) {

			final String ruPostfixKana2 = "れる";
			final String ruPostfixRomaji2 = "reru";

			GrammaFormConjugateResult potentialFormAlternative = makePotentialForm(dictionaryEntry, ruPostfixKana2,
					ruPostfixRomaji2);
	...
	private static GrammaFormConjugateResult makePotentialFormInformalPresentNegativeForm(
			GrammaFormConjugateResult potentialFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry potentialFormInformalPresentFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				potentialFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);
		...
		// replace result type
		potentialFormInformalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_INFORMAL_PRESENT_NEGATIVE);

		GrammaFormConjugateResult alternative = potentialFormInformalPresentForm.getAlternative();

		if (alternative != null) {

			DictionaryEntry alternativeAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
					alternative, DictionaryEntryType.WORD_VERB_RU);
			...
			alternativeInformalPresentNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_INFORMAL_PRESENT_NEGATIVE);
	...
	private static GrammaFormConjugateResult makePotentialFormInformalPastForm(
			GrammaFormConjugateResult potentialFormInformalPresentForm) {
	...
	private static GrammaFormConjugateResult makePotentialFormInformalPastNegativeForm(
			GrammaFormConjugateResult potentialFormInformalPresentForm) {
		...
		// replace result type
		potentialFormInformalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_INFORMAL_PAST_NEGATIVE);
		...
		if (alternative != null) {
			...
			alternativeInformalPastNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_INFORMAL_PAST_NEGATIVE);
	...
	private static GrammaFormConjugateResult makePotentialFormFormalPresentForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult potentialFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult potentialFormFormalPresentForm = makeFormalPresentForm(keigoHelper,
				potentialFormInformalPresentFormAsDictionaryEntry, false, false);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult alternativeFormalPresentForm = makeFormalPresentForm(keigoHelper,
					alternativeAsDictionaryEntry, false, false);
	...
	private static GrammaFormConjugateResult makePotentialFormFormalPresentNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult potentialFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry potentialFormInformalPresentNegativeFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				potentialFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);

		// make form
		GrammaFormConjugateResult potentialFormFormalPresentNegativeForm = makeFormalPresentNegativeForm(keigoHelper,
				potentialFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		potentialFormFormalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_FORMAL_PRESENT_NEGATIVE);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult alternativeFormalPresentNegativeForm = makeFormalPresentNegativeForm(keigoHelper,
					alternativeAsDictionaryEntry, false, false);

			alternativeFormalPresentNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_FORMAL_PRESENT_NEGATIVE);
	...
	private static GrammaFormConjugateResult makePotentialFormFormalPastForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult potentialFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult potentialFormFormalPastForm = makeFormalPastForm(keigoHelper,
				potentialFormInformalPresentNegativeFormAsDictionaryEntry, false, false);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult alternativeFormalPastForm = makeFormalPastForm(keigoHelper,
					alternativeAsDictionaryEntry, false, false);
	...
	private static GrammaFormConjugateResult makePotentialFormFormalPastNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult potentialFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult potentialFormFormalPastNegativeForm = makeFormalPastNegativeForm(keigoHelper,
				potentialFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		potentialFormFormalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_FORMAL_PAST_NEGATIVE);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult alternativeFormalPastNegativeForm = makeFormalPastNegativeForm(keigoHelper,
					alternativeAsDictionaryEntry, false, false);

			alternativeFormalPastNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_POTENTIAL_FORMAL_PAST_NEGATIVE);
	...
	private static GrammaFormConjugateResult makePotentialForm(DictionaryEntry dictionaryEntry, String ruPostfixKana,
			String ruPostfixRomaji) {
	...
	private static GrammaFormConjugateResult makePotentialTeForm(
			GrammaFormConjugateResult potentialFormInformalPresentForm) {
	...
	private static String makePotentialFormForKanjiOrKana(String kana, DictionaryEntryType dictionaryEntryType,
			String ruPostfixKana) {
	...
	private static String makePotentialFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType,
			String ruPostfixRomaji) {
	...
	private static String makeVolitionalFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType) {
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU) {
			...
			if (romajiLastThreeChars != null
					&& lastRomajiCharsMapperToCharForVolitionalForm.containsKey(romajiLastThreeChars) == true) {
			...
			if (romajiLastTwoChars != null
					&& lastRomajiCharsMapperToCharForVolitionalForm.containsKey(romajiLastTwoChars) == true) {
			...
			if (romajiLastOneChar != null
					&& lastRomajiCharsMapperToCharForVolitionalForm.containsKey(romajiLastOneChar) == true) {
	...
	private static DictionaryEntry convertGrammaFormConjugateResultToDictionaryEntry(
			GrammaFormConjugateResult grammaFormConjugateResult, DictionaryEntryType dictionaryEntryType) {
	...
	private static GrammaFormConjugateResult makeBaAffirmativeForm(DictionaryEntry dictionaryEntry,
			String ruPostfixKana, String ruPostfixRomaji) {
		...
		for (String currentKanaList : kanaList) {
			kanaListResult
					.add(makeBaAffirmativeFormForKanjiOrKana(currentKanaList, dictionaryEntryType, ruPostfixKana));
		}
		...
		for (String currentRomajiList : romajiList) {
			...
			romajiListResult
					.add(makeBaAffirmativeFormForRomaji(currentRomajiList, dictionaryEntryType, ruPostfixRomaji));
		}
	...
	private static String makeBaAffirmativeFormForKanjiOrKana(String kana, DictionaryEntryType dictionaryEntryType,
			String ruPostfixKana) {
	...
	private static String makeBaAffirmativeFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType,
			String ruPostfixRomaji) {
	...
	private static GrammaFormConjugateResult makeKeigoHighForm(KeigoHelper keigoHelper, DictionaryEntry dictionaryEntry) {
		...
		if (keigoEntry == null) {
			...
			result = GrammaExampleHelper.makeSimpleTemplateGrammaFormConjugateResult(stemForm, templateKanji,
					templateKana, templateRomaji);
			...
			for (String currentRomaji : romajiList) {
				romajiListResult.add(replaceEndWith(currentRomaji, keigoEntry.getRomaji(),
						keigoEntry.getKeigoRomaji(true)));
			}
			...
			if (keigoLongFormWithoutMasuKana != null) {
				...
				if (kanji != null) {
					...
					if (keigoEntry.getKanji() != null && keigoEntry.getKeigoKanji(true) != null) {
						masuResult.setKanji(replaceEndWith(kanji, keigoEntry.getKanji(),
								keigoEntry.getKeigoLongFormWithoutMasuKanji())
								+ "ます");
					} else {
						masuResult.setKanji(replaceEndWith(kanji, keigoEntry.getKana(), keigoLongFormWithoutMasuKana)
								+ "ます");
					}
				}
				...
				for (String currentKana : kanaList) {
					masuKanaListResult.add(replaceEndWith(currentKana, keigoEntry.getKana(),
							keigoLongFormWithoutMasuKana) + "ます");
				}
				...
				for (String currentRomaji : romajiList) {
					masuRomajiListResult.add(replaceEndWith(currentRomaji, keigoEntry.getRomaji(),
							keigoEntry.getKeigoLongFormWithoutMasuRomaji())
							+ "masu");
				}
	...
	private static GrammaFormConjugateResult makeKeigoLowForm(KeigoHelper keigoHelper, DictionaryEntry dictionaryEntry) {
		...
		KeigoEntry keigoEntry = keigoHelper.findKeigoLowEntry(dictionaryEntry.getDictionaryEntryType(),
				dictionaryEntry.getKanji(), dictionaryEntry.getKanaList(), dictionaryEntry.getRomajiList());
		...
		if (keigoEntry == null) {
			...
			resultInformalResult = GrammaExampleHelper.makeSimpleTemplateGrammaFormConjugateResult(stemForm,
					templateKanji, templateKana, templateRomaji);
			...
			if (kanji != null) {
				...
				if (keigoEntry.getKanji() != null && keigoEntry.getKeigoKanji(true) != null) {
					resultInformalResult.setKanji(replaceEndWith(kanji, keigoEntry.getKanji(),
							keigoEntry.getKeigoKanji(true)));

				} else if (keigoEntry.getKanji() == null && keigoEntry.getKeigoKanji(true) != null) {
					resultInformalResult.setKanji(replaceEndWith(kanji, keigoEntry.getKana(),
							keigoEntry.getKeigoKanji(true)));

				} else {
					resultInformalResult.setKanji(replaceEndWith(kanji, keigoEntry.getKana(),
							keigoEntry.getKeigoKana(true)));
				}
			} else if (keigoEntry.getKeigoKanji(true) != null) {
				resultInformalResult.setKanji(replaceEndWith(kanaList.get(0), keigoEntry.getKana(),
						keigoEntry.getKeigoKanji(true)));
			}
		...
		if (keigoEntry != null && keigoEntry.getKeigoLongFormWithoutMasuKana() != null) {
			...
			if (kanji != null) {
				...
				if (keigoEntry.getKanji() != null && keigoEntry.getKeigoKanji(true) != null) {
					...
					masuResult.setKanji(replaceEndWith(kanji, keigoEntry.getKana(),
							keigoEntry.getKeigoLongFormWithoutMasuKana())
							+ "ます");
				}
			}
			...
			DictionaryEntry virtualDictionaryEntry = GrammaExampleHelper.convertToVirtualDictionaryEntry(
					resultInformalResult, resultInformalResultDictiobaryEntryType);
	...
	private static GrammaFormConjugateResult makePassiveForm(DictionaryEntry dictionaryEntry, String postfixKana,
			String postfixRomaji) {
	...
	private static String makePassiveFormForKanjiOrKana(String kana, DictionaryEntryType dictionaryEntryType,
			String postfixKana) {
	...
	private static String makePassiveFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType,
			String postfixRomaji) {
	...
	private static GrammaFormConjugateResult makePassiveFormInformalPresentNegativeForm(
			GrammaFormConjugateResult passiveFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry passiveFormInformalPresentFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				passiveFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);
		...
		// replace result type
		passiveFormInformalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_PASSIVE_INFORMAL_PRESENT_NEGATIVE);

		return passiveFormInformalPresentNegativeForm;
	}

	private static GrammaFormConjugateResult makePassiveFormInformalPastForm(
			GrammaFormConjugateResult passiveFormInformalPresentForm) {
	...
	private static GrammaFormConjugateResult makePassiveFormInformalPastNegativeForm(
			GrammaFormConjugateResult passiveFormInformalPresentForm) {
		...
		// replace result type
		passiveFormInformalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_PASSIVE_INFORMAL_PAST_NEGATIVE);

		return passiveFormInformalPastNegativeForm;
	}

	private static GrammaFormConjugateResult makePassiveFormFormalPresentForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult passiveFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult passiveFormFormalPresentForm = makeFormalPresentForm(keigoHelper,
				passiveFormInformalPresentFormAsDictionaryEntry, false, false);
	...
	private static GrammaFormConjugateResult makePassiveFormFormalPresentNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult passiveFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry passiveFormInformalPresentNegativeFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				passiveFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);

		// make form
		GrammaFormConjugateResult passiveFormFormalPresentNegativeForm = makeFormalPresentNegativeForm(keigoHelper,
				passiveFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		passiveFormFormalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_PASSIVE_FORMAL_PRESENT_NEGATIVE);

		return passiveFormFormalPresentNegativeForm;
	}

	private static GrammaFormConjugateResult makePassiveFormFormalPastForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult passiveFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult passiveFormFormalPastForm = makeFormalPastForm(keigoHelper,
				passiveFormInformalPresentNegativeFormAsDictionaryEntry, false, false);
	...
	private static GrammaFormConjugateResult makePassiveFormFormalPastNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult passiveFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult passiveFormFormalPastNegativeForm = makeFormalPastNegativeForm(keigoHelper,
				passiveFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		passiveFormFormalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_PASSIVE_FORMAL_PAST_NEGATIVE);
	...
	private static GrammaFormConjugateResult makeCausativeForm(DictionaryEntry dictionaryEntry, String postfixKana,
			String postfixRomaji) {
	...
	private static String makeCausativeFormForKanjiOrKana(String kana, DictionaryEntryType dictionaryEntryType,
			String postfixKana) {
	...
	private static String makeCausativeFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType,
			String postfixRomaji) {
	...
	private static GrammaFormConjugateResult makeCausativeFormInformalPresentNegativeForm(
			GrammaFormConjugateResult causativeFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry causativeFormInformalPresentFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				causativeFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);
		...
		// replace result type
		causativeFormInformalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_INFORMAL_PRESENT_NEGATIVE);

		return causativeFormInformalPresentNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativeFormInformalPastForm(
			GrammaFormConjugateResult causativeFormInformalPresentForm) {
	...
	private static GrammaFormConjugateResult makeCausativeFormInformalPastNegativeForm(
			GrammaFormConjugateResult causativeFormInformalPresentForm) {
		...
		// replace result type
		causativeFormInformalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_INFORMAL_PAST_NEGATIVE);

		return causativeFormInformalPastNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativeFormFormalPresentForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativeFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult causativeFormFormalPresentForm = makeFormalPresentForm(keigoHelper,
				causativeFormInformalPresentFormAsDictionaryEntry, false, false);
	...
	private static GrammaFormConjugateResult makeCausativeFormFormalPresentNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativeFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry causativeFormInformalPresentNegativeFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				causativeFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);

		// make form
		GrammaFormConjugateResult causativeFormFormalPresentNegativeForm = makeFormalPresentNegativeForm(keigoHelper,
				causativeFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		causativeFormFormalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_FORMAL_PRESENT_NEGATIVE);

		return causativeFormFormalPresentNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativeFormFormalPastForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativeFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult causativeFormFormalPastForm = makeFormalPastForm(keigoHelper,
				causativeFormInformalPresentNegativeFormAsDictionaryEntry, false, false);
	...
	private static GrammaFormConjugateResult makeCausativeFormFormalPastNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativeFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult causativeFormFormalPastNegativeForm = makeFormalPastNegativeForm(keigoHelper,
				causativeFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		causativeFormFormalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_FORMAL_PAST_NEGATIVE);

		return causativeFormFormalPastNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativeTeForm(
			GrammaFormConjugateResult causativeFormInformalPresentForm) {
	...
	private static GrammaFormConjugateResult makeCausativePassiveFormInformalPresentForm(DictionaryEntry dictionaryEntry) {
		...
		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_U && kanaList.get(0).endsWith("す") == false) {
			...
			for (String currentKanaList : kanaList) {
				kanaListAlternativeResult.add(makeCausativePassiveFormForKanjiOrKana(currentKanaList,
						dictionaryEntryType, true));
			}
			...
			for (String currentRomajiList : romajiList) {
				romajiListAlternativeResult.add(makeCausativePassiveFormForRomaji(currentRomajiList,
						dictionaryEntryType, true));
			}
	...
	private static String makeCausativePassiveFormForKanjiOrKana(String kana, DictionaryEntryType dictionaryEntryType,
			boolean alternative) {

		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU
				|| (dictionaryEntryType == DictionaryEntryType.WORD_VERB_U && kana.endsWith("す") == true)) {
	...
	private static String makeCausativePassiveFormForRomaji(String romaji, DictionaryEntryType dictionaryEntryType,
			boolean alternative) {

		if (dictionaryEntryType == DictionaryEntryType.WORD_VERB_RU
				|| (dictionaryEntryType == DictionaryEntryType.WORD_VERB_U && romaji.endsWith("su") == true)) {
	...
	private static GrammaFormConjugateResult makeCausativePassiveFormInformalPresentNegativeForm(
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry causativePassiveFormInformalPresentFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				causativePassiveFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);
		...
		// replace result type
		causativePassiveFormInformalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_INFORMAL_PRESENT_NEGATIVE);
		...
		if (alternative != null) {
			...
			causativePassiveAlternativeFormInformalPresentNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_INFORMAL_PRESENT_NEGATIVE);

			causativePassiveFormInformalPresentNegativeForm
					.setAlternative(causativePassiveAlternativeFormInformalPresentNegativeForm);
		}

		return causativePassiveFormInformalPresentNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativePassiveFormInformalPastForm(
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {
		...
		// replace result type
		causativePassiveFormInformalPastForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_INFORMAL_PAST);
		...
		if (alternative != null) {
			...
			causativePassiveAlternativeFormInformalPastForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_INFORMAL_PAST);
	...
	private static GrammaFormConjugateResult makeCausativePassiveFormInformalPastNegativeForm(
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {
		...
		// replace result type
		causativePassiveFormInformalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_INFORMAL_PAST_NEGATIVE);
		...
		if (alternative != null) {
			...
			causativePassiveAlternativeFormInformalPastNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_INFORMAL_PAST_NEGATIVE);

			causativePassiveFormInformalPastNegativeForm
					.setAlternative(causativePassiveAlternativeFormInformalPastNegativeForm);
		}

		return causativePassiveFormInformalPastNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativePassiveFormFormalPresentForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult causativePassiveFormFormalPresentForm = makeFormalPresentForm(keigoHelper,
				causativePassiveFormInformalPresentFormAsDictionaryEntry, false, false);

		// replace result type
		causativePassiveFormFormalPresentForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PRESENT);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult causativePassiveAlternativeFormFormalPresentForm = makeFormalPresentForm(
					keigoHelper, alternativeAsDictionaryEntry, false, false);

			causativePassiveAlternativeFormFormalPresentForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PRESENT);
	...
	private static GrammaFormConjugateResult makeCausativePassiveFormFormalPresentNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {

		// convert to dictionary entry
		DictionaryEntry causativePassiveFormInformalPresentNegativeFormAsDictionaryEntry = convertGrammaFormConjugateResultToDictionaryEntry(
				causativePassiveFormInformalPresentForm, DictionaryEntryType.WORD_VERB_RU);

		// make form
		GrammaFormConjugateResult causativePassiveFormFormalPresentNegativeForm = makeFormalPresentNegativeForm(
				keigoHelper, causativePassiveFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		causativePassiveFormFormalPresentNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PRESENT_NEGATIVE);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult causativePassiveAlternativeFormFormalPresentNegativeForm = makeFormalPresentNegativeForm(
					keigoHelper, alternativeAsDictionaryEntry, false, false);

			causativePassiveAlternativeFormFormalPresentNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PRESENT_NEGATIVE);

			causativePassiveFormFormalPresentNegativeForm
					.setAlternative(causativePassiveAlternativeFormFormalPresentNegativeForm);
		}

		return causativePassiveFormFormalPresentNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativePassiveFormFormalPastForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult causativePassiveFormFormalPastForm = makeFormalPastForm(keigoHelper,
				causativePassiveFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		causativePassiveFormFormalPastForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PAST);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult causativePassiveAlternativeFormFormalPastForm = makeFormalPastForm(keigoHelper,
					alternativeAsDictionaryEntry, false, false);

			causativePassiveAlternativeFormFormalPastForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PAST);
	...
	private static GrammaFormConjugateResult makeCausativePassiveFormFormalPastNegativeForm(KeigoHelper keigoHelper,
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {
		...
		// make form
		GrammaFormConjugateResult causativePassiveFormFormalPastNegativeForm = makeFormalPastNegativeForm(keigoHelper,
				causativePassiveFormInformalPresentNegativeFormAsDictionaryEntry, false, false);

		// replace result type
		causativePassiveFormFormalPastNegativeForm
				.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PAST_NEGATIVE);
		...
		if (alternative != null) {
			...
			GrammaFormConjugateResult causativePassiveAlternativeFormFormalPastNegativeForm = makeFormalPastNegativeForm(
					keigoHelper, alternativeAsDictionaryEntry, false, false);

			causativePassiveAlternativeFormFormalPastNegativeForm
					.setResultType(GrammaFormConjugateResultType.VERB_CAUSATIVE_PASSIVE_FORMAL_PAST_NEGATIVE);

			causativePassiveFormFormalPastNegativeForm
					.setAlternative(causativePassiveAlternativeFormFormalPastNegativeForm);
		}

		return causativePassiveFormFormalPastNegativeForm;
	}

	private static GrammaFormConjugateResult makeCausativePassiveTeForm(
			GrammaFormConjugateResult causativePassiveFormInformalPresentForm) {
