...
public class AdjectiveIGrammaConjugater {
	...
	private static GrammaFormConjugateResult makeVirtualForm(DictionaryEntry dictionaryEntry) {
		...
		GrammaFormConjugateResult virtualForm = makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_VIRTUAL, "", "");
	...
	private static GrammaFormConjugateResult makeFormalPresentForm(DictionaryEntry dictionaryEntry) {
		...
		return makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_FORMAL_PRESENT, postfixKana, postfixRomaji);
	}
	...
	private static GrammaFormConjugateResult makeFormalPresentNegativeForm(DictionaryEntry dictionaryEntry) {
		...
		GrammaFormConjugateResult grammaFormConjugateResult = makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_FORMAL_PRESENT_NEGATIVE, postfixKana, postfixRomaji);
	...
	private static GrammaFormConjugateResult makeFormalPastNegativeForm(DictionaryEntry dictionaryEntry) {
		...
		GrammaFormConjugateResult grammaFormConjugateResult = makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_FORMAL_PAST_NEGATIVE, postfixKana, postfixRomaji);
	...
	private static GrammaFormConjugateResult makeInformalPresentForm(DictionaryEntry dictionaryEntry) {
		...
		return makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_INFORMAL_PRESENT, postfixKana, postfixRomaji);
	}
	...
	private static GrammaFormConjugateResult makeInformalPresentNegativeForm(DictionaryEntry dictionaryEntry) {
		...
		GrammaFormConjugateResult grammaFormConjugateResult = makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_INFORMAL_PRESENT_NEGATIVE, postfixKana, postfixRomaji);
	...
	private static GrammaFormConjugateResult makeInformalPastForm(DictionaryEntry dictionaryEntry) {
		...
		GrammaFormConjugateResult grammaFormConjugateResult = makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_INFORMAL_PAST, postfixKana, postfixRomaji);
	...
	private static GrammaFormConjugateResult makeInformalPastNegativeForm(DictionaryEntry dictionaryEntry) {
		...
		return makeAdjectiveGrammaConjugateForm(dictionaryEntry,
				GrammaFormConjugateResultType.ADJECTIVE_I_INFORMAL_PAST_NEGATIVE, postfixKana, postfixRomaji);
	}
	...
	private static String getRomajiToConjugate(String romaji,
			GrammaFormConjugateResultType grammaFormConjugateResultType) {
	...
	private static void validateDictionaryEntry(DictionaryEntry dictionaryEntry) {
		...
		boolean isAdjectiveIResult = dictionaryEntry.isDictionaryEntryType(DictionaryEntryType.WORD_ADJECTIVE_I);

		if (isAdjectiveIResult == false) {
