...
public class VerbExampler {
	...
	private static ExampleResult makeKeigoKudasai(KeigoHelper keigoHelper, DictionaryEntry dictionaryEntry,
		...
		if (dictionaryEntry.isDictionaryEntryType(DictionaryEntryType.WORD_VERB_IRREGULAR) == true) {
			...
			if (isKeigoHigh == true) {
				...
				KeigoEntry keigoEntry = keigoHelper.findKeigoHighEntry(dictionaryEntry.getDictionaryEntryTypeList(),
